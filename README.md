...
- **Таблицы** — горизонтальный скролл (календарь, журнал, клиенты, план тренировки)
...
- **Хедер** — sticky при скролле, компактный логотип, кнопки на всю ширину
- **Галерея** — фото 450–550px высотой, модалка просмотра по клику
- **Страницы** — адаптированы все: home, signup, subscriptions, gallery, contacts, login, schedule, nutrition, profile, journal, slots, program
- Тесты: 13 mobile E2E-тестов (бургер, все страницы, клиентские расписание/питание/профиль)
